...
const (
	Search_GetRecommendations_FullMethodName = "/Dressy.Search.Search/GetRecommendations"
)
...
func (c *searchClient) GetRecommendations(ctx context.Context, in *RecommendationRequest, opts ...grpc.CallOption) (*RecommendationResponse, error) {
...
func (UnimplementedSearchServer) GetRecommendations(context.Context, *RecommendationRequest) (*RecommendationResponse, error) {
...
func _Search_GetRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServer).GetRecommendations(ctx, req.(*RecommendationRequest))
	}
...
var Search_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Dressy.Search.Search",
